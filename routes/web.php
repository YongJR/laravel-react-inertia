...
Route::middleware(['auth','verified'])->group(function () {
    ...
    Route::post('/feature1', [Feature1Controller::class,'calculation'])->name('feature1.calculate');
    Route::get('/feature2', [Feature2Controller::class,'index'])->name('feature2.index');
    Route::post('/feature2', [Feature2Controller::class,'calculation'])->name('feature2.calculate');
